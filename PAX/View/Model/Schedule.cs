...
namespace PAX7.Model
{
    ...
    public class Schedule
    {
        ...
        public void checkForNewSchedule(string uri = null)
        {
            ...
            AnalyticsTracker tracker = new AnalyticsTracker();
            tracker.Track("Schedule", "UpdateCheck", uriVersionInfo);
        }
        ...
        void webClient_VersionInfoCompleted(object sender, OpenReadCompletedEventArgs evtArgs)
        {
            ...
            { 
                ...
                downloaded = false;
                AnalyticsTracker tracker = new AnalyticsTracker();
                tracker.Track("Schedule", "UpdateFailed");
            }
            ...
            if (downloaded) //we gots a file!
            {
                ...
                catch (Exception exception) //file exceptions
                {
                    ...
                    IsoStoreSettings.SaveToSettings<bool>(IsoStoreSettings.IsoStoreUpdateCheckFailed, true);
                    AnalyticsTracker tracker = new AnalyticsTracker();
                    tracker.Track("Schedule", "UpdateUnpackFailed");
                }
                ...
                catch(Exception exception) //file IO exceptions
                {
                    ...
                    hasUpdateAvailable = false;
                    AnalyticsTracker tracker = new AnalyticsTracker();
                    tracker.Track("Schedule", "UpdateReadVersionFailed");
                }
                ...
                if (scheduleData.versionNumber > IsoStoreSettings.GetScheduleVersion())
                {
                    ...
                    AnalyticsTracker tracker = new AnalyticsTracker();
                    tracker.Track("Schedule", "UpdateFound");
                }
                else 
                {
        ...
        public void DownloadNewEventFiles(string uri = null)
        {
            ...
            AnalyticsTracker tracker = new AnalyticsTracker();
            tracker.Track("Schedule", "UpdateDownload", uri);
        }
        ...
        private void webClient_OpenReadCompleted(object sender, OpenReadCompletedEventArgs e)
        {
            ...
            try
            {
                ...
                AnalyticsTracker tracker = new AnalyticsTracker();
                tracker.Track("Schedule", "UpdateLoadSuccess");

            }
            catch (Exception ex)
            {
                updateSucceeded = false;
                LittleWatson.ReportException(ex, "attempted at " + DateTime.Now);
                AnalyticsTracker tracker = new AnalyticsTracker();
                tracker.Track("Schedule", "UpdateLoadFailed");
            }
        ...
        public DateTime safeParse(string dateString, string eventName = null, string filename = null)
        {
